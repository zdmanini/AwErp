        ...
        >
            <el-form ref="formRef" :model="formData" label-width="84px" :rules="formRules">
                ...
                <el-form-item label="编码" prop="code">
                    <el-input v-model="formData.code" placeholder="请输入供应商编码" clearable />
                </el-form-item>
...
import { supplierEdit, supplierAdd, supplierDetail } from '@/api/basic/supplier'
...
const handleSubmit = async () => {
    ...
    mode.value == 'edit' ? await supplierEdit(formData) : await supplierAdd(formData)
