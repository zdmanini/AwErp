<template>
    <div class="customer-lists">
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <div>
                <el-button v-perms="['basic:customer:add']" type="primary" @click="handleAdd()">
                    <template #icon>
...
import { customerDelete, customerLists, customerChange } from '@/api/basic/customer'
